...
//
// Added for this app's Vite/ESM build: the file below references React.* as
// a bare namespace (Claude Design's browser preview loads it via a global
// <script> tag, no import needed there) — this app bundles via ES modules,
// so React must be imported explicitly for those references to resolve.
